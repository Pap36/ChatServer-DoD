...
Possible moves: LOOK - displays a 5X5 grid which represents the surroundings of the player. The player is always in the center of the grid. MOVE N/E/S/W - moves in the specified direction PICKUP - pickus up Gold if the player is currently on a Gold tile. QUIT - exits the game. If the player is on an exit tile and has more than the required gold, then the player wins.
